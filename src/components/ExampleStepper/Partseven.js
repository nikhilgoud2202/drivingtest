        ...
        <div className="Container">
            ...
            <form>
                <div class="form-group form-row">
                    ...
                    <label class="col-sm-3 control-label" for="w6-provide_age_proof">MISCELLANEOUS QUS-1:</label>
                    <div class="col-sm-3">
                    ...
                    <label class="col-sm-3 control-label" for="w6-worked_before">MISCELLANEOUS QUS-2:</label>
                    <div class="col-sm-3">
                        <div class="radio-custom radio-info">
                ...
                <div class="form-group form-row">
                    ...
                    <label class="col-sm-3 control-label" for="w6-provide_age_proof">MISCELLANEOUS QUS-3:</label>
                    <div class="col-sm-3">
                        <div class="radio-custom radio-info">
                            <input id="provide_age_proof_yes" name="provide_age_proof" type="radio" value="Yes" required />
                            <label for="provide_age_proof_yes">Yes</label>
                    ...
                    <label class="col-sm-3 control-label" for="w6-worked_before">MISCELLANEOUS QUS-4:</label>
                    <div class="col-sm-3">
                        <div class="radio-custom radio-info">
                            <input id="worked_before_yes" name="worked_before" type="radio" value="Yes" required />
                            <label for="worked_before_yes">Yes</label>
                ...
                <div class="form-group form-row">
                    ...
                    <label class="col-sm-3 control-label" for="w6-provide_age_proof">MISCELLANEOUS QUS-5:</label>
                    <div class="col-sm-3">
                        <div class="radio-custom radio-info">
                            <input id="provide_age_proof_yes" name="provide_age_proof" type="radio" value="Yes" required />
                            <label for="provide_age_proof_yes">Yes</label>
                    ...
                    <label class="col-sm-3 control-label" for="w6-worked_before">MISCELLANEOUS QUS-6:</label>
                    <div class="col-sm-3">
                        <div class="radio-custom radio-info">
                            <input id="worked_before_yes" name="worked_before" type="radio" value="Yes" required />
                            <label for="worked_before_yes">Yes</label>
